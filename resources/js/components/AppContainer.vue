          ...
          <v-col class="text-center">
            ...
            >
                ...
                <v-col cols="8" class="text-justify">
                    ...
                    <div>
                        <div class="headline" color="blue">We want to hear your feedback!</div>
                        <div>Food Delivery Service</div>
                    </div>
                    </v-card-title>
                    <div class="pa-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis sint odit harum atque quo eveniet pariatur corporis asperiores fugiat nam magnam</div>
                </v-col>
                <v-img
                    class="shrink ma-2"
                    contain
                    ...
                    <v-toolbar flat color="white">
                        ...
                        <div class="text-center">
                            <v-btn rounded color="primary" dark v-on="on">
                                <v-icon left>mdi-pencil</v-icon>Post Review
                            </v-btn>
                        </div>
                        </template>
...
<script>
  export default {
    ...
    data: () => ({
      drawer: null,
      rating: 4.5, // *not fixed, it should get the ave of ratings
